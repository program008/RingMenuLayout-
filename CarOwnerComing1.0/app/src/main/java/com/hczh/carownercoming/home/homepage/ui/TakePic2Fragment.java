 ...
 * on 2016/4/14.
 */
public class TakePic2Fragment extends BaseFragment implements View.OnClickListener {
    @ViewInject(R.id.take_picture_btn1_iv2)
    private ImageView takePicBtn1;
    @ViewInject(R.id.take_picture_btn2_iv2)
    private ImageView takePicBtn2;
    @ViewInject(R.id.take_picture_btn3_iv2)
    private ImageView takePicBtn3;

    final int REQUEST_CODE=1; //用来标识跳到哪个activity的
    @Override
    protected int getLayout() {
        return R.layout.fragment_car_accidents_take_pic2;
    }
